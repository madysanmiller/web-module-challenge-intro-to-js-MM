...
Do the following:   
   ...
   HINT: no function required
*/
let FirstThing = 'firstThing' ;
let SecondThing = 'secondThing' ;

if(SecondThing === 'secondThing'){
  FirstThing = 'thirdThing' ;
}else{FirstThing = 'firstThing' ;
}
...
const SandStorm = '1999';
console.log('task 1c:', Number(SandStorm));
